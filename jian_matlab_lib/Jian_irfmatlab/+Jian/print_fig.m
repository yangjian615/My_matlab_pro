...
%Jian.PRINT_FIG Exports figure to file.
%   Jian.PRINT_FIG(fileName) exports current figure to a .eps with name
%   fileName.
%   Jian.PRINT_FIG(f,fileName) exports figure with handle f to a .eps named
%   fileName. If f is an integer, the figure with that number is printed.
%   Jian.PRINT_FIG(fileName,fileType) exports current figure to a file named
%   fileName with format fileType.
%   Jian.PRINT_FIG(f,fileName,fileType) exports figure with handle f
