...
%
function varargout = kempo1_mac(varargin)

% Last Modified by GUIDE v2.5 17-Mar-2005 20:36:26

if nargin == 0  % LAUNCH GUI
  %-- Startup --
  %try
    hspfig = splash_screen;
    ht = timer('TimerFcn',sprintf('delete(1)'),'StartDelay',3);
    start(ht)
