function [data, file_meta, filenameList] = eqn_UniversalSpaceDataLoader_Swarm(...
...
dateList = (floor(DATE_RANGE(1)):1:floor(DATE_RANGE(end)))';
...
%         'Swarm_L1B_CDF_ORBATT_MAGNET_ACCELE\', ...
%             VERSION, '\', ...
%             dateStrings(i, 1:4), '\', ...
%             dateStrings(i, 5:6), '\', ...
%             dateStrings(i, 7:8), '\',...
